...
./deis login --username=$DEIS_USERNAME --password=$DEIS_PASSWORD deis.champagne.deis.com
DEIS_BINARY_NAME=./_scripts/deis DEIS_APP_NAME=k8s-claimer make -C .. deploy-to-deis
